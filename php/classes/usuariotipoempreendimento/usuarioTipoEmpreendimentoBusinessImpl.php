...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listUsuarioTipoEmpreendimentoPorStatus($status, $pag, $qtde, $coluna, $ordem);
...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listUsuarioTipoEmpreendimentoPorUsuaIdStatus($usuaid, $status, $pag, $qtde, $coluna, $ordem);
