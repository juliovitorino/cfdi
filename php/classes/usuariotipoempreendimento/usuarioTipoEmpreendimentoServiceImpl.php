...
require_once 'UsuarioTipoEmpreendimentoService.php';
...
/**
*
* UsuarioTipoEmpreendimentoServiceImpl - Implementação dos servicos para Classe de negócio com métodos para apoiar a integridade de informações sobre relação usuario x tipo de empreendimento gerenciado pela plataforma
* Camada de Serviços UsuarioTipoEmpreendimento - camada responsável pela lógica de negócios de UsuarioTipoEmpreendimento do sistema. 
...
*
*/
class UsuarioTipoEmpreendimentoServiceImpl implements UsuarioTipoEmpreendimentoService
{
...
/**
*
* listarTudo() - Usado para invocar a classe de negócio UsuarioTipoEmpreendimentoBusinessImpl de forma geral
...
/**
*
* PesquisarMaxPKAtivoIdPorStatus() - Usado para invocar a classe de negócio UsuarioTipoEmpreendimentoBusinessImpl de forma geral
...
public function pesquisarMaxPKAtivoIdusuarioPorStatus($idUsuario,$status)
{
    ...
    try {
       ...
       $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
...
/**
*
* atualizar() - Usado para invocar a classe de negócio UsuarioTipoEmpreendimentoBusinessImpl de forma geral
* para gerenciar as regras de negócio do sistema.
*
* @param UsuarioTipoEmpreendimentoDTO contendo dados para enviar para atualização
* @return uma instância de UsuarioTipoEmpreendimentoDTO com resultdo da operação
*
*/
...
/**
*
* atualizarStatusUsuarioTipoEmpreendimento() - Usado para invocar a classe de negócio UsuarioTipoEmpreendimentoBusinessImpl de forma geral
...
/**
*
* apagar() - Usado para invocar a classe de negócio UsuarioTipoEmpreendimentoBusinessImpl de forma geral
* para gerenciar a exclusão de registro de acordo as regras de negócio do sistema.
*
* @param $dto - Instância de UsuarioTipoEmpreendimentoDTO
*
* @return uma instância de UsuarioTipoEmpreendimentoDTO com resultdo da operação
*
*/
...
/**
*
* cadastrar() - Usado para invocar a classe de negócio UsuarioTipoEmpreendimentoBusinessImpl de forma geral
...
*/
    ...
    public function cadastrar($dto)
    {
        ...
        try {
           ...
           $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
           $retorno = $bo->inserirUsuarioTipoEmpreendimento($daofactory, $dto);
...
*/
    ...
    public function listarPagina($pag, $qtde)
    {
        ...
        try {
            ...
            // listar paginado UsuarioTipoEmpreendimento
           $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
...
* realizar uma busca diretamente pela PK (Primary Key) da tabela USUARIO_TIPO_EMPREENDIMENTO campo USTE_ID
*
* @param $id
* @return UsuarioTipoEmpreendimentoDTO
*
...
*/
    ...
    public function pesquisarPorID($id)
    {
        ...
        try {
            ...
            // pesquisar pela PK da tabela UsuarioTipoEmpreendimento
           $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
...
/**
*
* listarUsuarioTipoEmpreendimentoPorStatus() - Usado para invocar a classe de negócio TipoEmpreendimentoBusinessImpl de forma geral
...
*/
   ...
   public function listarUsuarioTipoEmpreendimentoPorStatus($status='A', $pag=1, $qtde=0, $coluna=1, $ordem=0) 
   {
       ...
       try {
           ...
           // listar paginado UsuarioTipoEmpreendimento
           $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
           $retorno = $bo->listarUsuarioTipoEmpreendimentoPorStatus($daofactory, $status, $pag, $qtde, $coluna, $ordem);
           $daofactory->commit();
       } catch (Exception $e) {
           // rollback na transação
...
*/
    ...
    public function pesquisarPorIdusuario($idUsuario)
    {
        ...
        try {
            ...
            // pesquisar pelo atributo UsuarioTipoEmpreendimento.idUsuario no campo USUA_ID da tabela USUARIO_TIPO_EMPREENDIMENTO
           $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
...
*/
    ...
    public function pesquisarPorIdtipoempreendimento($idTipoEmpreendimento)
    {
        ...
        try {
            ...
            // pesquisar pelo atributo UsuarioTipoEmpreendimento.idTipoEmpreendimento no campo TIEM_ID da tabela USUARIO_TIPO_EMPREENDIMENTO
           $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
           $retorno = $bo->carregarPorIdtipoempreendimento($daofactory, $idTipoEmpreendimento);
           if ($retorno->msgcode == ConstantesMensagem::COMANDO_REALIZADO_COM_SUCESSO){
                $daofactory->commit();
           } else {
                $daofactory->rollback();
...
*/
    ...
    public function atualizarIdusuarioPorPK($idUsuario,$id)
    {
        ...
        try {
            ...
            // atualizar registro por meio do método UsuarioTipoEmpreendimentoBusinessImpl::atualizarIdusuarioPorPK($idUsuario,$id)
           $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
...
*/
    ...
    public function atualizarIdtipoempreendimentoPorPK($idTipoEmpreendimento,$id)
    {
        ...
        try {
            ...
            // atualizar registro por meio do método UsuarioTipoEmpreendimentoBusinessImpl::atualizarIdtipoempreendimentoPorPK($idTipoEmpreendimento,$id)
           $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
           $retorno = $bo->atualizarIdtipoempreendimentoPorPK($daofactory,$idTipoEmpreendimento,$id);
...
/**
*
* listarUsuarioTipoEmpreendimentoPorUsuaIdStatus() - Usado para invocar a classe de negócio TipoEmpreendimentoBusinessImpl de forma geral
...
*/
   ...
   public function listarUsuarioTipoEmpreendimentoPorUsuaIdStatus($usuaid, $status='A', $pag=1, $qtde=0, $coluna=1, $ordem=0) 
   {
       ...
       try {
           ...
           // listar paginado UsuarioTipoEmpreendimento
           $bo = new UsuarioTipoEmpreendimentoBusinessImpl();
           $retorno = $bo->listarUsuarioTipoEmpreendimentoPorUsuaIdStatus($daofactory, $usuaid, $status, $pag, $qtde, $coluna, $ordem);
           $daofactory->commit();
       } catch (Exception $e) {
           // rollback na transação
