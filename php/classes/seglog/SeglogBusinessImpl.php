...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listSeglogPorStatus($status, $pag, $retorno->itensPorPagina, $coluna, $ordem);
...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listSeglogPorUsuaIdStatus($usuaid, $status, $pag, $retorno->itensPorPagina, $coluna, $ordem);
