...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listCampanhaSorteioFilaCriacaoPorStatus($status, $pag, $qtde, $coluna, $ordem);
...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listCampanhaSorteioFilaCriacaoPorUsuaIdStatus($usuaid, $status, $pag, $qtde, $coluna, $ordem);
