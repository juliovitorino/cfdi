...
require_once 'ufService.php';
require_once 'ufBusinessImpl.php';
...
/**
* UfServiceImpl - Implementação dos servicos
*/
class UfServiceImpl implements UfService
{
    ...
    public function atualizar($dto)
    {
        ...
        try {
            ...
            // excluir assinante da Uf
           $bo = new UfBusinessImpl();
    ...
    public function pesquisarPorID($id)
    {
        ...
        try {
            ...
            // pesquisar pela PK da tabela Uf
           $bo = new UfBusinessImpl();
...
public function listarUfPorStatus($status, $pag=1, $qtde=0, $coluna=1, $ordem=0) 
   {
       ...
       try {
           ...
           $bo = new UfBusinessImpl();
           $retorno = $bo->listarUfPorStatus($daofactory, $status, $pag, $qtde, $coluna, $ordem);
           $daofactory->commit();
       } catch (Exception $e) {
           // rollback na transação
