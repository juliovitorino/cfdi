...
class ConstantesMensagem
{
	...
	const USUARIO_CASHBACK_NAO_PERMITE_TRANSFERIR_ENTRE_MEMBRO = 'MSG-0189';
	const USUARIO_CASHBACK_NAO_PERMITE_RESGATE_VIA_PIX = 'MSG-0190';
	const USUARIO_TRANSFERENCIA_DONO_DO_CASHBACK = 'MSG-0191';
	const REMUNERACAO_PROMOTOR = 'MSG-0192';
	const NOTIFICACAO_REMUNERACAO_PROMOTOR = 'MSG-0193';
	const REMUNERACAO_NOVO_USUARIO = 'MSG-0194';
	const NOTIFICACAO_REMUNERACAO_NOVO_USUARIO = 'MSG-0195';
	const SALDO_INSUFICIENTE_FUNDO_PARTICIPACAO_GLOBAL = 'MSG-0196';
	const VALOR_INVALIDO_FUNDO_PARTICIPACAO_GLOBAL = 'MSG-0197';
	const AVISO_CREDITO_FUNDO_PARTICIPACAO_GLOBAL = 'MSG-0198';
