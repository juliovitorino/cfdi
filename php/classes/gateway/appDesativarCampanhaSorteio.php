...
// URL http://elitefinanceira.com/cfdi/php/classes/gateway/appDesativarCampanhaSorteio.php
// URL http://localhost/cfdi/php/classes/gateway/appDesativarCampanhaSorteio.php


 /*
Faça um Find/Replace em $_GET por $_POST e use os parametros na URL para simular um GET na HttpRequest

http://elitefinanceira.com/cfdi/php/classes/gateway/appDesativarCampanhaSorteio.php?tokenid=c5e6c403027c888c64c75c2cbd05444b3c71de96&casoid=1140

 */

/**
*
* appDesativarCampanhaSorteio - destivar uma campanha em status = INATIVO (PERMANENTEMENTE)
*
*======================================================================================
