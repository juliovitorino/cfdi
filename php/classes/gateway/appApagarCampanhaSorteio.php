...
// URL http://elitefinanceira.com/cfdi/php/classes/gateway/appApagarCampanhaSorteio.php
// URL http://localhost/cfdi/php/classes/gateway/appApagarCampanhaSorteio.php


 /*
Faça um Find/Replace em $_GET por $_POST e use os parametros na URL para simular um GET na HttpRequest

http://elitefinanceira.com/cfdi/php/classes/gateway/appApagarCampanhaSorteio.php?tokenid=c5e6c403027c888c64c75c2cbd05444b3c71de96&casoid=1140

 */

/**
*
* appApagarCampanhaSorteio - Apagar uma campanha sorteio de forma permanente
*
*======================================================================================
