...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listFilaPublicidadePorStatus($status, $pag, $retorno->itensPorPagina, $coluna, $ordem);
...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listFilaPublicidadePorUsuaIdStatus($usuaid, $status, $pag, $retorno->itensPorPagina, $coluna, $ordem);
