...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listRegistroIndicacaoPorStatus($status, $pag, $retorno->itensPorPagina, $coluna, $ordem);
...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listRegistroIndicacaoPorUsuaIdStatus($usuaid, $status, $pag, $retorno->itensPorPagina, $coluna, $ordem);
