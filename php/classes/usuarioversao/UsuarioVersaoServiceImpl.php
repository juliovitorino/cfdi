...
require_once 'UsuarioVersaoService.php';
require_once 'UsuarioVersaoBusinessImpl.php';
...
/**
*
* UsuarioVersaoServiceImpl - Implementação dos servicos para Classe de negócio com métodos para apoiar a integridade de informações sobre a versão do aplicativo no dispositivo do usuário gerenciado pela plataforma
* Camada de Serviços UsuarioVersao - camada responsável pela lógica de negócios de UsuarioVersao do sistema. 
...
*
*/
class UsuarioVersaoServiceImpl implements UsuarioVersaoService
{
...
/**
*
* listarTudo() - Usado para invocar a classe de negócio UsuarioVersaoBusinessImpl de forma geral
...
/**
*
* PesquisarMaxPKAtivoIdPorStatus() - Usado para invocar a classe de negócio UsuarioVersaoBusinessImpl de forma geral
...
*/
    public function verificarVersaoSistema($id_usuario, $versao)
    {
        ...
        try {
           ...
           $bo = new UsuarioVersaoBusinessImpl();
           $retorno = $bo->verificarVersaoSistema($daofactory, $id_usuario, $versao);
...
public function PesquisarMaxPKAtivoId_VersaoPorStatus($id_versao,$status)
{
    ...
    try {
       ...
       $bo = new UsuarioVersaoBusinessImpl();
       $retorno = $bo->PesquisarMaxPKAtivoId_VersaoPorStatus($daofactory, $id_versao,$status);
       if ($retorno->msgcode == ConstantesMensagem::COMANDO_REALIZADO_COM_SUCESSO) {
            $daofactory->commit();
        } else {
            $daofactory->rollback();
...
/**
*
* atualizar() - Usado para invocar a classe de negócio UsuarioVersaoBusinessImpl de forma geral
* para gerenciar as regras de negócio do sistema.
*
* @param UsuarioVersaoDTO contendo dados para enviar para atualização
* @return uma instância de UsuarioVersaoDTO com resultdo da operação
*
*/
...
/**
*
* atualizarStatusUsuarioVersao() - Usado para invocar a classe de negócio UsuarioVersaoBusinessImpl de forma geral
...
/**
*
* cadastrar() - Usado para invocar a classe de negócio UsuarioVersaoBusinessImpl de forma geral
* para gerenciar a criação de registro de acordo as regras de negócio do sistema.
*
* @param $dto - Instância de UsuarioVersaoDTO
*
* @return uma instância de UsuarioVersaoDTO com resultdo da operação
*
*/
...
* realizar uma busca diretamente pela PK (Primary Key) da tabela USUARIO_VERSAO campo USVE_ID
*
* @param $id
* @return UsuarioVersaoDTO
*
...
*/
    ...
    public function pesquisarPorID($id)
    {
        ...
        try {
            ...
            // pesquisar pela PK da tabela UsuarioVersao
           $bo = new UsuarioVersaoBusinessImpl();
...
/**
*
* listarUsuarioVersaoPorStatus() - Usado para invocar a classe de negócio TipoEmpreendimentoBusinessImpl de forma geral
...
*/
   ...
   public function listarUsuarioVersaoPorStatus($status='A', $pag=1, $qtde=0, $coluna=1, $ordem=0) 
   {
       ...
       try {
           ...
           // listar paginado UsuarioVersao
           $bo = new UsuarioVersaoBusinessImpl();
           $retorno = $bo->listarUsuarioVersaoPorStatus($daofactory, $status, $pag, $qtde, $coluna, $ordem);
           $daofactory->commit();
       } catch (Exception $e) {
           // rollback na transação
...
*/
    ...
    public function pesquisarPorId_Versao($id_versao)
    {
        ...
        try {
            ...
            // pesquisar pelo atributo UsuarioVersao.id_versao no campo VERS_ID da tabela USUARIO_VERSAO
           $bo = new UsuarioVersaoBusinessImpl();
           $retorno = $bo->carregarPorId_Versao($daofactory, $id_versao);
           if ($retorno->msgcode == ConstantesMensagem::COMANDO_REALIZADO_COM_SUCESSO){
                $daofactory->commit();
           } else {
                $daofactory->rollback();
...
*/
    ...
    public function pesquisarPorId_Usuario($id_usuario)
    {
        ...
        try {
            ...
            // pesquisar pelo atributo UsuarioVersao.id_usuario no campo USUA_ID da tabela USUARIO_VERSAO
           $bo = new UsuarioVersaoBusinessImpl();
...
*/
    ...
    public function atualizarId_VersaoPorPK($id_versao,$id)
    {
        ...
        try {
            ...
            // atualizar registro por meio do método UsuarioVersaoBusinessImpl::atualizarId_VersaoPorPK($id_versao,$id)
           $bo = new UsuarioVersaoBusinessImpl();
           $retorno = $bo->atualizarId_VersaoPorPK($daofactory,$id_versao,$id);
...
*/
    ...
    public function atualizarId_UsuarioPorPK($id_usuario,$id)
    {
        ...
        try {
            ...
            // atualizar registro por meio do método UsuarioVersaoBusinessImpl::atualizarId_UsuarioPorPK($id_usuario,$id)
           $bo = new UsuarioVersaoBusinessImpl();
...
/**
*
* listarUsuarioVersaoPorUsuaIdStatus() - Usado para invocar a classe de negócio TipoEmpreendimentoBusinessImpl de forma geral
...
*/
   ...
   public function listarUsuarioVersaoPorUsuaIdStatus($usuaid, $status='A', $pag=1, $qtde=0, $coluna=1, $ordem=0) 
   {
       ...
       try {
           ...
           // listar paginado UsuarioVersao
           $bo = new UsuarioVersaoBusinessImpl();
           $retorno = $bo->listarUsuarioVersaoPorUsuaIdStatus($daofactory, $usuaid, $status, $pag, $qtde, $coluna, $ordem);
           $daofactory->commit();
       } catch (Exception $e) {
           // rollback na transação
