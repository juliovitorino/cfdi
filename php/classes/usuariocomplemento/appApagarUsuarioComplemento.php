...
// URL http://junta10.dsv:8080/cfdi/php/classes/gateway/appApagarUsuarioComplemento.php?tokenid=tk&id=tr

/**
*
* appApagarUsuarioComplemento - Controlador para permitir acesso ao backend no método apagar()
* da classe UsuarioComplemento.php
