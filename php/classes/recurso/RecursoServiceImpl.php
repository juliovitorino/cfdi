...
require_once 'RecursoService.php';
...
/**
*
* RecursoServiceImpl - Implementação dos servicos para Classe de negócio com métodos para apoiar a integridade de informações sobre recursos gerenciado pela plataforma
* Camada de Serviços Recurso - camada responsável pela lógica de negócios de Recurso do sistema. 
...
*
*/
class RecursoServiceImpl implements RecursoService
{
...
/**
*
* listarTudo() - Usado para invocar a classe de negócio RecursoBusinessImpl de forma geral
...
/**
*
* PesquisarMaxPKAtivoIdPorStatus() - Usado para invocar a classe de negócio RecursoBusinessImpl de forma geral
...
/**
*
* atualizar() - Usado para invocar a classe de negócio RecursoBusinessImpl de forma geral
* para gerenciar as regras de negócio do sistema.
*
* @param RecursoDTO contendo dados para enviar para atualização
* @return uma instância de RecursoDTO com resultdo da operação
*
*/
...
/**
*
* atualizarStatusRecurso() - Usado para invocar a classe de negócio RecursoBusinessImpl de forma geral
...
/**
*
* apagar() - Usado para invocar a classe de negócio RecursoBusinessImpl de forma geral
* para gerenciar a exclusão de registro de acordo as regras de negócio do sistema.
*
* @param $dto - Instância de RecursoDTO
*
* @return uma instância de RecursoDTO com resultdo da operação
*
*/
...
/**
*
* cadastrar() - Usado para invocar a classe de negócio RecursoBusinessImpl de forma geral
...
*/
    ...
    public function cadastrar($dto)
    {
        ...
        try {
           ...
           $bo = new RecursoBusinessImpl();
           $retorno = $bo->inserirRecurso($daofactory, $dto);
...
* realizar uma busca diretamente pela PK (Primary Key) da tabela RECURSO campo RECU_ID
*
* @param $id
* @return RecursoDTO
*
...
*/
    ...
    public function pesquisarPorID($id)
    {
        ...
        try {
            ...
            // pesquisar pela PK da tabela Recurso
           $bo = new RecursoBusinessImpl();
...
/**
*
* listarRecursoPorStatus() - Usado para invocar a classe de negócio TipoEmpreendimentoBusinessImpl de forma geral
...
*/
   ...
   public function listarRecursoPorStatus($status='A', $pag=1, $qtde=0, $coluna=1, $ordem=0) 
   {
       ...
       try {
           ...
           // listar paginado Recurso
           $bo = new RecursoBusinessImpl();
           $retorno = $bo->listarRecursoPorStatus($daofactory, $status, $pag, $qtde, $coluna, $ordem);
           $daofactory->commit();
       } catch (Exception $e) {
           // rollback na transação
...
*/
    ...
    public function pesquisarPorDescricao($descricao)
    {
        ...
        try {
            ...
            // pesquisar pelo atributo Recurso.descricao no campo RECU_TX_DESCRICAO da tabela RECURSO
           $bo = new RecursoBusinessImpl();
...
*/
    ...
    public function atualizarDescricaoPorPK($descricao,$id)
    {
        ...
        try {
            ...
            // atualizar registro por meio do método RecursoBusinessImpl::atualizarDescricaoPorPK($descricao,$id)
           $bo = new RecursoBusinessImpl();
...
/**
*
* listarRecursoPorUsuaIdStatus() - Usado para invocar a classe de negócio TipoEmpreendimentoBusinessImpl de forma geral
...
*/
   ...
   public function listarRecursoPorUsuaIdStatus($usuaid, $status='A', $pag=1, $qtde=0, $coluna=1, $ordem=0) 
   {
       ...
       try {
           ...
           // listar paginado Recurso
           $bo = new RecursoBusinessImpl();
           $retorno = $bo->listarRecursoPorUsuaIdStatus($daofactory, $usuaid, $status, $pag, $qtde, $coluna, $ordem);
           $daofactory->commit();
       } catch (Exception $e) {
           // rollback na transação
