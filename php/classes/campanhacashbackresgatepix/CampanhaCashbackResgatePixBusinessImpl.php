...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listCampanhaCashbackResgatePixPorStatus($status, $pag, $qtde, $coluna, $ordem);
...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listCampanhaCashbackResgatePixPorUsuaIdStatus($usuaid, $status, $pag, $qtde, $coluna, $ordem);
