...
class DmlSqlCampanhaCashbackResgatePix extends DmlSql
{
    ...
    const CCRP_TX_ESTAGIO_ANALISE = 'CCRP_TX_ESTAGIO_ANALISE';
    const CCRP_DT_ESTAGIO_FINANCEIRO = 'CCRP_DT_ESTAGIO_FINANCEIRO';
    const CCRP_TX_ESTAGIO_FINANCEIRO = 'CCRP_TX_ESTAGIO_FINANCEIRO';
    const CCRP_DT_ESTAGIO_ERRO = 'CCRP_DT_ESTAGIO_ERRO';
    const CCRP_TX_ESTAGIO_ERRO = 'CCRP_TX_ESTAGIO_ERRO';
    const CCRP_DT_ESTAGIO_TRANSF_BCO = 'CCRP_DT_ESTAGIO_TRANSF_BCO';
    const CCRP_TX_ESTAGIO_TRANSF_BCO = 'CCRP_TX_ESTAGIO_TRANSF_BCO';
    ...
    . ' `' . self::CCRP_TX_ESTAGIO_ANALISE . '` = ?, '
    . ' `' . self::CCRP_DT_ESTAGIO_FINANCEIRO . '` = ?, '
    . ' `' . self::CCRP_TX_ESTAGIO_FINANCEIRO . '` = ?, '
    . ' `' . self::CCRP_DT_ESTAGIO_ERRO . '` = ?, '
    . ' `' . self::CCRP_TX_ESTAGIO_ERRO . '` = ?, '
    . ' `' . self::CCRP_DT_ESTAGIO_TRANSF_BCO . '` = ?, '
    . ' `' . self::CCRP_TX_ESTAGIO_TRANSF_BCO . '` = ?, '
    ...
    const UPD_CAMPANHA_CASHBACK_RESGATE_PIX_CCRP_TX_ESTAGIO_ANALISE_PK = 'UPDATE `' . self::TABELA . '` set ' . ' `' . self::CCRP_TX_ESTAGIO_ANALISE . '` = ? ' . 'WHERE ' . ' `' . self::CCRP_ID . '` = ? ' ;
    const UPD_CAMPANHA_CASHBACK_RESGATE_PIX_CCRP_TX_ESTAGIO_FINANCEIRO_PK = 'UPDATE `' . self::TABELA . '` set ' . ' `' . self::CCRP_TX_ESTAGIO_FINANCEIRO . '` = ? ' . 'WHERE ' . ' `' . self::CCRP_ID . '` = ? ' ;
    ...
    const UPD_CAMPANHA_CASHBACK_RESGATE_PIX_CCRP_TX_ESTAGIO_ERRO_PK = 'UPDATE `' . self::TABELA . '` set ' . ' `' . self::CCRP_TX_ESTAGIO_ERRO . '` = ? ' . 'WHERE ' . ' `' . self::CCRP_ID . '` = ? ' ;
    ...
    const UPD_CAMPANHA_CASHBACK_RESGATE_PIX_CCRP_TX_ESTAGIO_TRANSF_BCO_PK = 'UPDATE `' . self::TABELA . '` set ' . ' `' . self::CCRP_TX_ESTAGIO_TRANSF_BCO . '` = ? ' . 'WHERE ' . ' `' . self::CCRP_ID . '` = ? ' ;
