...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listUsuarioNotificacaoPorStatus($status, $pag, $qtde, $coluna, $ordem);
...
*/
    ...
    {   
        ...
        $retorno->lst = $dao->listUsuarioNotificacaoPorUsuaIdStatus($usuaid, $status, $pag, $qtde, $coluna, $ordem);
