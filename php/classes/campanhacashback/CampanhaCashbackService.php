...
/**
*
* CampanhaCashbackService - Interfaces dos servicos para Classe de negócio com métodos para apoiar a integridade de informações sobre o programa de cashback gerenciado pela plataforma
* Interface de Serviços CampanhaCashback - camada responsável pela lógica de negócios de CampanhaCashback do sistema. 
...
interface CampanhaCashbackService extends AppService
{
