...
/**
*
* listarFilaEmailPorFilaStatus() - Usado para invocar a classe de negócio TipoEmpreendimentoBusinessImpl de forma geral
* realizar lista paginada de registros com uma instância de PaginacaoDTO
*
* @param $status
* @param $pag
...
*/
   ...
   public function listarFilaEmailPorFilaStatus($fila, $status='A', $pag=1, $qtde=0, $coluna=1, $ordem=0)
   {
       ...
       try {
           ...
           // listar paginado FilaEmail
           $bo = new FilaEmailBusinessImpl();
           $retorno = $bo->listarFilaEmailPorFilaStatus($daofactory, $fila, $status, $pag, $qtde, $coluna, $ordem);
           $daofactory->commit();
       } catch (Exception $e) {
           // rollback na transação
