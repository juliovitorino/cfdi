...
ALTER TABLE `CAMPANHA` ADD COLUMN `CAMP_IN_PERM_BONIF_J10` varchar(1)  NOT NULL DEFAULT 'S' COMMENT 'Permite bonificar financeiramento no J10';

ALTER TABLE `USUARIO_CASHBACK` ADD COLUMN `USCA_IN_PERM_TRANSF_MEMJ10` varchar(1) NOT NULL DEFAULT 'S' COMMENT 'Permite transferir saldo entre membros J10';
ALTER TABLE `USUARIO_CASHBACK` ADD COLUMN `USCA_IN_PERM_RESGATE_PIX` varchar(1) NOT NULL DEFAULT 'N' COMMENT 'Permite solicitar resgate via PIX';
